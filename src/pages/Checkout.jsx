          ...
          <div className="row">
            <div className="col-7">
              <div className="checkout-left-data">
                <h3 className="website-name">MartBay by ClutchDeveloper</h3>
                ...
                <p className="user-details total">Henry Chidi (clutchdeveloper@gmail.com)</p>
                ...
                <div className="d-flex gap-10 mb-2 align-items-center">
                  <div className="w-75 d-flex gap-10">
                    <div className="w-25 position-relative">
                      <span style={{ top: "-10px", right: "-5px" }} className="badge bg-secondary text-white rounded-circle p-2 position-absolute">
                        1
                      </span>
                      <img src={watch} alt="product" className="img-fluid" />
                    </div>
                    <div>
                      <h5 className="total-price">iWatch</h5>
                      <p className="total-price">s / #new product</p>
                    </div>
                  </div>
                  <div className="flex-grow-1">
